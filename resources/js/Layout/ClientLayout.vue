                ...
                <nav class="w-full">
                    <ul class="list-none m-0 p-0 flex overflow-x-auto items-center py-4">
                        <li class="inline-block reveal-up" :style="{'--delay':'0.1s'}">
                            <inertia-link class="nav-link" :class="{'active' : $route.isCurrent('client.dashboard')}"
                                :href="$route.relativePath('client.dashboard')">Dashboard</inertia-link>
                        </li>
                        <li class="inline-block reveal-up" :style="{'--delay':'0.3s'}">
                            <inertia-link class="nav-link" :class="{'active' : $route.isCurrent('client.profile.index')}"
                                :href="$route.relativePath('client.profile.index')">Profile</inertia-link>
                        </li>
                        <li class="inline-block reveal-up" :style="{'--delay':'0.5s'}">
                            <inertia-link class="nav-link" :class="{'active' : $route.isCurrent('client.invoice')}"
                                :href="$route.relativePath('client.invoice')">Invoice</inertia-link>
                        </li>
                    </ul>
                </nav>
            </div>
